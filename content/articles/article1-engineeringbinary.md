...
这个提炼不是品味问题，它是两门生意的分界。软件公司写一次、卖很多次；而一个照着某个客户的组织结构长出来的 feature，永远只能卖给那一个客户。这种东西做多了，你就是在开一门发票上印着产品 logo 的咨询公司。**这和下面部署那一节是同一个陷阱，只是高了一层。** 所以动手之前要问的不是"有没有客户要这个"，而是：**这个东西能不能卖给下一个没提过它的客户？**
