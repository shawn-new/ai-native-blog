...
Everything in the previous two sections is about owning an asset. This one is not. Distribution and deployment are about having a path into the customer at all, and it is the only item on my original list that was not a restatement of the others.
